...
- C++23 or later
- CMake 3.20 or later
- [freetype/freetype](https://github.com/freetype/freetype)
- [nigels-com/glew](https://github.com/nigels-com/glew)
- [Thomas-Baricault/colors](https://github.com/Thomas-Baricault/colors)
- [Thomas-Baricault/images](https://github.com/Thomas-Baricault/images)
- [Thomas-Baricault/math](https://github.com/Thomas-Baricault/math)
...
```bash
git clone https://github.com/Thomas-Baricault/graphics.git
cd graphics
make install
```
